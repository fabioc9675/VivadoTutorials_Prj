...
proc init_gui { IPINST } {
  ...
  #Adding Group
  set FPGA_IP [ipgui::add_group $IPINST -name "FPGA IP" -layout horizontal]
  set_property tooltip {FPGA IP} ${FPGA_IP}
  ipgui::add_param $IPINST -name "FPGA_IP_1" -parent ${FPGA_IP} -show_label false -show_range false
  ipgui::add_param $IPINST -name "FPGA_IP_2" -parent ${FPGA_IP} -show_label false -show_range false
  ipgui::add_param $IPINST -name "FPGA_IP_3" -parent ${FPGA_IP} -show_label false
  ipgui::add_param $IPINST -name "FPGA_IP_4" -parent ${FPGA_IP} -show_label false

  #Adding Group
  set HOST_IP [ipgui::add_group $IPINST -name "HOST IP" -layout horizontal]
  ipgui::add_param $IPINST -name "HOST_IP_1" -parent ${HOST_IP} -show_label false -show_range false
  ...
  #Adding Group
  set PORTS [ipgui::add_group $IPINST -name "PORTS"]
  ...
  ipgui::add_param $IPINST -name "FPGA_MAC" -parent ${MAC_ADDRESS}
  ipgui::add_param $IPINST -name "HOST_MAC" -parent ${MAC_ADDRESS}

  ipgui::add_param $IPINST -name "HEADER_CHECKSUM"
  ipgui::add_param $IPINST -name "CHECK_DESTINATION"
